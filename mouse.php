...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr, en" lang="fr, en">
  ...
  <li><a href="#"><font color="white">catégorie
          ...
          <ul>
  <li><a href="categorie/laptop.php"><font color="white">Laptop</font></a></li>
  <li><a href="categorie/phone.php"><font color="white">phone</font></a></li>
  <li><a href="categorie/books.php"><font color="white">Books</font></a></li>
  <li><a href="#"><font color="white">Gadget</font><i class="fas fa-caret-right"></i>            </a>

  <font color="white"></font>
              <ul>
  <li><a href="categorie/Keyboard.php"><font color="white">Keyboard</font></a></li>
  <li><a href="categorie/mouse.php"><font color="white">Mouse</font></a></li>
  <li><a href="categorie/headphones.php"><font color="white">Headphone</font></a></li>
  <li><a href="categorie/smartwatch.php"><font color="white">Smart Watch</font></a></li>
  </ul>
  </li>
  </ul>
  </li>
  ...
  <section>
    <div class="container" style="width: 75%">
        ...
        <?php
        $query = "SELECT * FROM produit WHERE categorie like 'mou%'";
